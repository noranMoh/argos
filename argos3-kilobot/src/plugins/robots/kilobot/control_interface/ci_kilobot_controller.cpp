...
void CCI_KilobotController::ControlStep() {
   ...
   hetFact = (double)(std::stoi( id_str.erase(0,2) ) - N/2.0) * (double)(2.0/N) * 0.08; // kilo_ID [0 N-1]
   hetFact_L = 1.0 - 0.5*hetFact;
   hetFact_R = 1.0 + 0.5*hetFact;

   
   // std::cout << id_str.erase(0,2) << std::endl;
